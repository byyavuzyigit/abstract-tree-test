public class Linden extends Tree{
    ...
    public int compareTo(Tree lindenTree){
        ...
        String addTwo = lindenTree.getAddress();
        ...
        String nameTwo = lindenTree.getName();
        int name_compare = nameOne.compareTo(nameTwo);
        if(name_compare<0)
            return -2;
        if(name_compare>0)
            return 2;
        if(this.getAge()<lindenTree.getAge())
            return -1;
        if(this.getAge()>lindenTree.getAge())
            return 1;
    ...
    public void printMessage(){
        System.out.println("This is an Linden tree named <" + this.getName() +">!");
    }
    public String toString(){
        String line1 = "Type: Linden";
